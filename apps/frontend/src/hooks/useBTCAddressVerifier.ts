...
export type GetBtcAddrValidationReturnType = {
  code: number;
  result: boolean;
  error: boolean;
};
...
export type useBtcAddressValidatorParameters<
  selectData = GetBtcAddrValidationReturnType,
> = Evaluate<
  GetBtcValidationParameters &
    UseQueryParameters<
      Evaluate<GetBtcAddrValidationReturnType>,
      Error,
      selectData,
      GetBtcValidationQueryKey
    >
>;

export type useBtcAddressValidatorReturnType<
  selectData = GetBtcAddrValidationReturnType,
> = UseQueryResult<selectData, Error>;

export const useBtcAddressValidator = <
  selectData = GetBtcAddrValidationReturnType,
>(
